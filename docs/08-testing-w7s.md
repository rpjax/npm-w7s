...
the tool running *Speculum's* tests. Different things, easy to confuse, so the words stay
...
2. Whatever it *can* do for real in a temporary directory is done for real. Faking the part
